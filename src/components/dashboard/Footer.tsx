			...
			<div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 md:flex-row md:px-8">
				...
				<div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
					<Link
						...
						className="flex shrink-0 whitespace-nowrap items-center gap-2 rounded-full border border-border bg-surface-900 !p-2.5 sm:!px-3 sm:!py-1.5 !text-xs !font-medium text-fg-muted transition-colors hover:border-accent-500/50 hover:text-accent-600"
					>
					...
					<Dialog open={contactOpen} onOpenChange={setContactOpen}>
						<DialogTrigger asChild>
							<button className="flex shrink-0 whitespace-nowrap items-center gap-2 rounded-full border border-border bg-surface-900 !p-2.5 sm:!px-3 sm:!py-1.5 !text-xs !font-medium text-fg-muted transition-colors hover:border-accent-500/50 hover:text-accent-600">
								<IconMail size={16} />
						...
						<DialogContent>
							...
							<div className="flex flex-col gap-3 mt-4">
								<Link
									...
									className="flex items-center gap-3 rounded-xl border border-border bg-surface-950 p-4 transition-colors hover:border-accent-500 hover:bg-elevated group"
								>
									<IconMail className="text-fg-muted group-hover:text-accent-600 transition-colors" size={24} />
									<div className="flex flex-col">
										<span className="font-semibold text-fg">Email</span>
										<span className="text-sm text-fg-muted">louis.chabanon@gmail.com</span>
									</div>
								</Link>
								<Link
									...
									target="_blank"
									rel="noopener noreferrer"
									className="flex items-center gap-3 rounded-xl border border-border bg-surface-950 p-4 transition-colors hover:border-green-500 hover:bg-elevated group"
								>
									<IconBrandWhatsapp className="text-fg-muted group-hover:text-green-600 transition-colors" size={24} />
									<div className="flex flex-col">
										<span className="font-semibold text-fg">WhatsApp</span>
										<span className="text-sm text-fg-muted">Envoyer un message WhatsApp</span>
									</div>
								</Link>
							</div>
						</DialogContent>
