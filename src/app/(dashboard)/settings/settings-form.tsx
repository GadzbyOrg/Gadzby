			...
			<div className="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2">
				<div className="sm:col-span-2">
					...
					<div className="relative mt-2">
						<div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
							<IconMail className="h-5 w-5 text-fg-subtle" />
						</div>
						<input
							type="email"
							name="email"
				...
				<div className="sm:col-span-2">
					<InputLabel htmlFor="phone">Téléphone <span className="text-fg-subtle text-xs font-normal">(Optionnel)</span></InputLabel>
					<div className="relative mt-2">
						<div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
							<IconPhone className="h-5 w-5 text-fg-subtle" />
						</div>
						<input
							type="tel"
							name="phone"
				...
				<div>
					...
					<div className="relative mt-2">
						<div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
							<IconId className="h-5 w-5 text-fg-subtle" />
						</div>
						<input
							type="text"
							name="bucque"
