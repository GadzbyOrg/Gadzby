            ...
            <div className="grid gap-6">
                ...
                <div className="bg-dark-900 border border-dark-800 rounded-2xl overflow-hidden">
                    <div className="px-6 py-4 border-b border-dark-800 flex items-center gap-3">
                        ...
                        <h2 className="font-semibold text-white">Historique des inventaires</h2>
                    </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-sm">
                                ...
                                <tbody className="divide-y divide-dark-800">
                                    {audits.map((audit) => (
                                        <tr key={audit.id} className="hover:bg-dark-800/50 transition-colors">
                                            <td className="px-6 py-4 text-gray-300">
                                                {new Date(audit.createdAt).toLocaleDateString()} à {new Date(audit.createdAt).toLocaleTimeString()}
                                            </td>
                                                {audit.creator ? `${audit.creator.prenom} ${audit.creator.nom}` : "Inconnu"}
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                ...
                                                >
                                                    {audit.status === 'COMPLETED' ? 'Voir le rapport' : 'Continuer'}
                                                </Link>
                                            </td>
                                        </tr>
                                    ))}
