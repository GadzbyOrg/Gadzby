        ...
        return (
            <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                ...
                <div className="mt-4 text-center">
                    <Link href={`/shops/${slug}/manage/inventory`} className="text-fg-muted hover:text-fg transition-colors">
                        ← Retour à la liste
                    </Link>
                </div>
            </div>
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8">
            <div className="flex items-center gap-4 text-sm text-fg-subtle mb-4">
                <Link href={`/shops/${shop.slug}/manage/inventory`} className="hover:text-fg transition-colors">
                    ← Retour à l&apos;inventaire
                </Link>
                <span>/</span>
                <span className="text-fg font-medium">Audit du {new Date(audit.createdAt).toLocaleDateString()}</span>
            </div>
            ...
            <header>
                <div className="flex flex-wrap items-center gap-3 mb-2">
                    ...
                    <span
                        className={`px-3 py-1 rounded-full text-xs font-medium border ${audit.status === "COMPLETED"
