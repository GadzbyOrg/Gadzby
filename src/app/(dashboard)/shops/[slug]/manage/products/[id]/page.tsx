	...
	return (
		<div className="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8">
			<div className="flex items-center gap-4 text-sm text-fg-subtle mb-4">
				...
				<span>/</span>
				<span className="text-fg font-medium">Modifier produit</span>
			</div>
			...
			<header>
				...
				<p className="text-fg-muted">Modifiez les informations du produit.</p>
			</header>

			<div className="bg-surface-950/50 border border-border p-6 rounded-2xl">
				<ProductForm
					shopSlug={slug}
