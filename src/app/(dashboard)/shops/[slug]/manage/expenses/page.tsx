import { getShopExpenses, createShopExpense, deleteShopExpense } from "@/features/shops/expenses";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="rounded-2xl bg-dark-900 border border-dark-800 p-6 sticky top-6">
                        <h2 className="text-xl font-semibold text-white mb-4">Nouvelle Dépense</h2>
                    ...
                    <div className="rounded-2xl bg-dark-900 border border-dark-800 overflow-hidden">
                        <div className="p-6 border-b border-dark-800 flex justify-between items-center">
                            ...
                            <div className="text-sm text-gray-400">
                                Total: <span className="text-white font-medium">{(totalExpenses / 100).toFixed(2)} €</span>
                            </div>
                        </div>
