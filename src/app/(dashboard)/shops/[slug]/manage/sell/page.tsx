...
export default async function ShopPosPage({
	...
	return (
		<div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
			<div className="flex items-center gap-4 text-sm text-fg-subtle mb-2">
				<Link
				...
				<span>/</span>
				<span className="text-fg font-medium">Point de Vente</span>
			</div>

			<header className="border-b border-border pb-6 mb-6">
				<h1 className="text-3xl font-bold text-fg tracking-tight">
					<span className="text-accent-500">VENTE </span>
					{shop.name}
				</h1>
				<p className="text-fg-muted">Interface de vente pour les boul&apos;c.</p>
			</header>
