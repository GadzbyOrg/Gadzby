...
export function TopUpUserForm() {
    ...
    const [selectedUser, setSelectedUser] = useState<any>(null); // Type 'User' if imported
	...
	return (
		<form action={clientAction} className="space-y-6 bg-dark-900 p-6 rounded-xl border border-dark-800 shadow-xl">
            <div>
