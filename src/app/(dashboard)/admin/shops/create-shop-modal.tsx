    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button className="bg-accent-600 hover:bg-accent-700 text-fg gap-2">
                    <IconPlus size={18} />
                    Nouveau Shop
                </Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[425px] bg-surface-900 border-border text-fg">
                <DialogHeader>
                ...
                <form action={onSubmit} className="grid gap-4 py-4">
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            required
                            className="bg-surface-950 border-border focus:border-accent-500"
                        />
                    </div>
                    <div className="grid gap-2">
                        ...
                        <Input
                            ...
                            className="bg-surface-950 border-border focus:border-accent-500"
                        />
                        <p className="text-xs text-fg-subtle">Généré automatiquement si vide</p>
                    </div>
                    <div className="grid gap-2">
                        ...
                        <Textarea
                            ...
                            className="bg-surface-950 border-border focus:border-accent-500 resize-none"
                        />
                    </div>
                    <DialogFooter>
                        <Button
                            type="submit"
                            className="bg-accent-600 hover:bg-accent-700 text-fg w-full sm:w-auto"
                            disabled={loading}
                        >
