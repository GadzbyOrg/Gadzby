    ...
    return (
        <form action={action} className="space-y-6">
            ...
            <div className="grid gap-6">
                ...
                <div>
                    <label htmlFor="balance" className="block text-sm font-medium text-gray-400 mb-2">
                        Solde
                    </label>
                    ...
                    <p className="mt-2 text-xs text-gray-500">
                        Attention : Modifier le solde manuellement crée un déséquilibre comptable s'il n'est pas justifié.
                    </p>
                </div>
            </div>
