...
export function CreateFamForm() {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex gap-4 items-end bg-dark-900 p-4 rounded-lg border border-dark-800">
            ...
            {error && <span className="text-red-500 text-sm ml-2 self-center">{error}</span>}
            {success && <span className="text-green-500 text-sm ml-2 self-center">{success}</span>}
        </form>
    );
}
