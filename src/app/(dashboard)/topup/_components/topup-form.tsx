...
export function TopUpForm({ methods }: { methods: PaymentMethod[] }) {
  ...
  const [selectedMethod, setSelectedMethod] = useState<string>(methods[0]?.slug || "");
  ...
  if (methods.length === 0) {
      return <div className="text-center text-gray-400">Aucun moyen de paiement disponible pour le moment.</div>;
  }
    ...
    <div className="grid gap-8 lg:grid-cols-2">
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-white">1. Choisissez un montant</h2>
        ...
        {/* Provider Selection */}
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-white">2. Moyen de paiement</h2>
              ...
              >
                <div className="flex items-center gap-4">
                  <div className={cn(
                      ...
                      selectedMethod === method.slug ? "bg-primary-600/20 text-primary-500" : "bg-dark-800 text-gray-500"
                  )}>
                    <IconCreditCard size={20} />
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-200">{method.name}</h3>
                    <p className="text-xs text-gray-500">
                        Frais: {method.fees.fixed / 100}€ + {method.fees.percentage}%
                    </p>
                  </div>
                </div>
                {selectedMethod === method.slug && (
        ...
        <div className="sticky top-8 rounded-2xl border border-dark-800 bg-dark-900/50 p-6 backdrop-blur-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-end justify-between">
              ...
              <span className="text-3xl font-bold text-primary-500">{total.toFixed(2)} €</span>
            </div>
