                            ...
                            <div>
                                ...
                                <div className="relative mt-2">
                                    ...
                                    <input
                                        ...
                                        className="block w-full rounded-md border-0 bg-surface-950 py-2.5 pl-10 text-fg shadow-sm ring-1 ring-inset ring-border placeholder:text-fg-subtle focus:ring-2 focus:ring-inset focus:ring-accent-600 sm:text-sm sm:leading-6 transition-all"
                                    />
                                </div>
                            </div>
